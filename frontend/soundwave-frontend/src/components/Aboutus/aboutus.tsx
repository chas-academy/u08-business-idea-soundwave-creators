    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
        ...
        <p className="leading-relaxed text-lg">
          Welcome to our company! We are dedicated to providing the best services and products to our customers. Our team is composed of passionate and experienced professionals who are committed to excellence and innovation. We believe in creating value and making a positive impact in the communities we serve. Thank you for being a part of our journey.
        </p>
